					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee App",
									"targetURL": "#employeeapplication-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"employeeapplication-display": {
								"semanticObject": "employeeapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeeapplication",
									"url": sap.ui.require.toUrl("employeeapplication")
								}
							}
						}
					}
